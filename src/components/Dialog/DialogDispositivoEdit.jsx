    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-xs" onClick={onClose}>
            <div onClick={(e) => e.stopPropagation()} className="max-w-md w-full m-4">
                <View title="Editar Dispositivo" text="Ingrese los detalles del dispositivo" estilos="p-6" >
                    <form onSubmit={handleSubmit}>
                        <div className="mb-4">
                            <label htmlFor="nombre" className="block text-gray-700 font-bold ">Nombre del Dispositivo</label>
                                <input type="text"
                                        id="nombre"
                                        name="nombre" 
                                        placeholder="Ej: Sensor Oficina 1" 
                        ...
                        <div className="mb-4">
                            ...
                            <input type="text" 
                                    id="ubicacion" 
                                    name="ubicacion" 
                                    placeholder="Ej: Piso 3, Sala de Reuniones" 
                                    value={ubicacion} 
