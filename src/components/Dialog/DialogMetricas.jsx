...
import { postMetricasApi } from "../../services/metricasService";

export default function DialogMetricas({isOpen, onClose, onDispositivoAgregado}) {
...
const [unidad, setUnidad] = useState('');
    ...
    const handleSubmit = async (e) =>{
        e.preventDefault();
            ...
            try{
                const respuesta = await postMetricasApi({ nombre, unidad });
